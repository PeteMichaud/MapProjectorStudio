...
{
    abstract class CylindricalBase : Transform
    {
        // x is g(phi)*lambda
        // y is f(phi)
        ...
        // Abstract
        protected abstract bool GetXY(double phi, double lambda, ref double x, ref double y);
        ...
        public override (int w, int h) AdjustSize(int w, int h,
                       TransformParams tParams)
        {
            ...
            double h0 = GetMaxHeight(tParams);
